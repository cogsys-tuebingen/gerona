...
void saveSingleSurf(ofstream &outfile, const Ipoint &ipt, bool attribs=true, bool save_class)
{
...
//! Save the SURF features to file
void saveSurf(char *filename, vector<Ipoint> &ipts, bool save_class)
{
...
void loadSurf(char *filename, vector<Ipoint> &ipts, bool append, bool load_class)
{
