...
enum PER_STATES
{
    ...
    PERS_GOALREACHED        = 3,
    PERS_OUTOFIMAGE         = -1,
    PERS_LOWWHEELSUPPORT_FAR= -2,
    PERS_NOWHEELSUPPORT     = -3,
    PERS_LOWWHEELSUPPORT    = -4,
    PERS_EXCEEDGRAVANGLE    = -5,
    PERS_EXCEEDTIPANGLE     = -6,
    PERS_EXCEEDDELTAANGLE   = -7,
    PERS_CHASSISCOLLISION   = -8,
    PERS_NOTASSIGNED        = -10
};
