...
class RobotController_EKM_TT: public RobotController
{
public:
    /**
     * @brief RobotController_Kinematic_HBZ
     */
    RobotController_EKM_TT();
...
private:
    ...
    bool targetTransform2base(ros::Time& now,Waypoint pathEnd);
...
protected:
    ...
    struct Command
    {
        RobotController_EKM_TT *parent_;
        ...
        Command(RobotController_EKM_TT *parent):
            parent_(parent),
