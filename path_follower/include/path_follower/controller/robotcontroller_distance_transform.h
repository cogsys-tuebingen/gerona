#ifndef ROBOTCONTROLLER_DISTANCETRANSFORM_H
#define ROBOTCONTROLLER_DISTANCETRANSFORM_H
...
/// LIBRARIES
#include <dt_planner/idtplanner.h>
...
class RobotController_DT: public RobotController
{
public:
    /**
...
protected:
    ...
    struct Command
    {
        ...
        Command(RobotController_DT *parent):
            parent_(parent),
