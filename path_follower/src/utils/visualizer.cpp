...
Visualizer::Visualizer() :
    private_nh_("~")
{
    vis_pub_ = nh_.advertise<visualization_msgs::Marker>("visualization_marker", 100);
    marray_vis_pub_ = nh_.advertise<visualization_msgs::MarkerArray>("visualization_marker_array", 100);
}
