...
//          options: @skel@, long double .  
//          Do not edit this file.
//
//  gslmm::matrix_long_double
...
#define GSLMM_matrix_long_double
#line 29 "matrix_skel.hh"
/** @file   matrix_long_double.hh
    @author Christian Holm
    @date   Mon Mar 10 14:50:12 2003
    @brief  @c long double  specialisation of matrix class */
...
#endif
#ifndef GSLMM_vectormatrix_vector_long_double
...
namespace gslmm
{
  /** @brief Matrix @c long double  specialisation.
      @ingroup matrix
   */
  template <>
  ...
  public:
    ...
    /** Low level data type */
    typedef gsl_matrix_long_double data_type;
    /** Low level view type */
    typedef gsl_matrix_long_double_view view_type;
    ...
    matrix<long double > operator()(iterator row, iterator column, 
...
namespace gslmm
{
  ...
  inline matrix<long double >::matrix(oper_type p) 
    : _matrix(0)
  {
    assert(p.get());
    if (!p.get()) GSL_ERROR_VOID("NULL return passed", GSL_EINVAL);
    _matrix = gsl_matrix_long_double_calloc(p->row_size(), p->column_size());
    p->operator()(*this);
    // delete p;
    // p = 0;
  }
  ...
  //__________________________________________________________________
  inline matrix<long double >::matrix(size_t rows, size_t columns, bool zero) 
    : _matrix(0)
  {
    if (zero) _matrix = gsl_matrix_long_double_calloc(rows, columns);
    else      _matrix = gsl_matrix_long_double_alloc(rows, columns);
  }
  //__________________________________________________________________
  inline matrix<long double >::matrix(const matrix<value_type>& m,
				bool trans
#if 0
				, bool conj
#endif
  ...
  {
    if (!trans) {
      _matrix = gsl_matrix_long_double_alloc(m.row_size(), m.column_size());
      *this = m;
    }
    else {
      _matrix = gsl_matrix_long_double_alloc(m.column_size(), m.row_size());
      gsl_matrix_long_double_transpose_memcpy(_matrix,m._matrix);
    }
#if 0
    if (conj) conjugate();
#endif
  ...
  //__________________________________________________________________
  inline 
  matrix<long double >::matrix(const matrix<value_type>& m, 
			 iterator row_offset, iterator column_offset, 
			 size_type rows, size_type columns, 
			 size_type) 
    : _matrix(0)
  {
    view_type v = gsl_matrix_long_double_submatrix(m._matrix,
					    row_offset, 
					    column_offset,
					    rows, columns);
    from_view(v);
  ...
  //__________________________________________________________________
  inline matrix<long double >::matrix(element_type* array, 
				size_type rows, size_type columns, 
				size_type tda) 
    : _matrix(0)
  {
    view_type v;
    if (tda <= 0)
      v = gsl_matrix_long_double_view_array(array, rows, columns);
    else 
      v = gsl_matrix_long_double_view_array_with_tda(array, rows, columns, tda);
    from_view(v);
  }
  //__________________________________________________________________
  inline 
  matrix<long double >::matrix(const vector_type& vec,
			 size_type rows, size_type columns, 
			 size_type tda) 
     : _matrix(0)
 {
    view_type v;
    if (tda <= 0)
      v = gsl_matrix_long_double_view_vector(vec._vector, rows, columns);
    else 
      v = gsl_matrix_long_double_view_vector_with_tda(vec._vector, rows, 
							columns, tda);
    from_view(v);
  }
  
  //__________________________________________________________________
  inline matrix<long double >::~matrix()
  {
    gsl_matrix_long_double_free(_matrix);
  }
  //__________________________________________________________________
  inline void matrix<long double >::from_view(view_type& v)
  {
  ...
  //__________________________________________________________________
  inline matrix<long double >&
  matrix<long double >::operator=(const matrix<value_type>& m)
  {
    gsl_matrix_long_double_memcpy(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<long double >&
  matrix<long double >::operator=(oper_type p)
  {
    assert(p.get());
  ...
  //__________________________________________________________________
  inline void
  matrix<long double >::swap(const matrix<value_type>& m)
  {
    gsl_matrix_long_double_swap(_matrix,m._matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<long double >::swap_rows(iterator i, iterator j)
  {
    gsl_matrix_long_double_swap_rows(_matrix,i, j);
  }
  //__________________________________________________________________
  inline void
  matrix<long double >::swap_columns(iterator i, iterator j)
  {
    gsl_matrix_long_double_swap_columns(_matrix,i, j);
  }
  //__________________________________________________________________
  inline void
  matrix<long double >::swap_row_column(iterator i, iterator j)
  {
    gsl_matrix_long_double_swap_rowcol(_matrix,i, j);
  }
  //__________________________________________________________________
  inline bool
  matrix<long double >::is_owner()  const
  {
    return _matrix->owner == 1;
  }
  //__________________________________________________________________
  inline bool
  matrix<long double >::is_null()  const 
  {
    return gsl_matrix_long_double_isnull(_matrix) == 1;
  }
  //__________________________________________________________________
  inline void
  matrix<long double >::zero() 
  {
    gsl_matrix_long_double_set_zero(_matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<long double >::set(value_type x) 
  {
    gsl_matrix_long_double_set_all(_matrix, x);
  }
  //__________________________________________________________________
  inline void
  matrix<long double >::identity()
  {
    gsl_matrix_long_double_set_identity(_matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<long double >::transpose()
  {
    gsl_matrix_long_double_transpose(_matrix);
  }
  //__________________________________________________________________
  inline matrix<long double >
  matrix<long double >::operator()(iterator i, iterator j, size_type n1, 
				   size_type n2) const
  {
    return matrix<long double >(*this, i, j, n1, n2);
  }
  //__________________________________________________________________
  inline 
  const matrix<long double >::reference_type
  matrix<long double >::operator()(iterator i, iterator j) const 
  {
#if 0
    return reference_type(gsl_matrix_long_double_ptr(_matrix, i, j));
#else 
    return reference_type(*(gsl_matrix_long_double_ptr(_matrix, i, j)));
#endif
  }
  //__________________________________________________________________
  inline 
  matrix<long double >::reference_type
  matrix<long double >::operator()(iterator i, iterator j) 
  {
#if 0
    return reference_type(gsl_matrix_long_double_ptr(_matrix, i, j));
#else 
  ...
  //__________________________________________________________________
  inline matrix<long double >::vector_type
  matrix<long double >::operator[](iterator i)
  {
    // Must be implemented here - temporary
    return vector_type(gsl_matrix_long_double_row(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<long double >::vector_type
  matrix<long double >::operator[](iterator i) const
  {
    // Must be implemented here - temporary
    return vector_type(gsl_matrix_long_double_row(_matrix,i));
  }
  //__________________________________________________________________
  inline matrix<long double >::value_type*
  matrix<long double >::element(iterator row, iterator column) 
  {
    // Must be implemented here - temporary
    
    return (value_type*)(gsl_matrix_long_double_ptr(_matrix,row, column));
  }
  //__________________________________________________________________
  inline const matrix<long double >::value_type*
  matrix<long double >::element(iterator row, iterator column) const
  {
    // Must be implemented here - temporary
    return (value_type*)(gsl_matrix_long_double_const_ptr(_matrix,row, column));
  }
  //__________________________________________________________________
  inline matrix<long double >::vector_type
  matrix<long double >::row(iterator i)
  {
    return vector_type(gsl_matrix_long_double_row(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<long double >::vector_type
  matrix<long double >::row(iterator i) const
  {
    return vector_type(gsl_matrix_long_double_row(_matrix,i));
  }
  //__________________________________________________________________
  inline matrix<long double >::vector_type
  matrix<long double >::column(iterator i)
  {
    return vector_type(gsl_matrix_long_double_column(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<long double >::vector_type
  matrix<long double >::column(iterator i) const
  {
    return vector_type(gsl_matrix_long_double_column(_matrix,i));
  }
  //__________________________________________________________________
  inline matrix<long double >::vector_type
  matrix<long double >::diagonal(int i)
  {
    if (i == 0)     
      return vector_type(gsl_matrix_long_double_diagonal(_matrix));
    else if (i < 0) 
      return 
	vector_type(gsl_matrix_long_double_subdiagonal(_matrix,-i));
    return 
      vector_type(gsl_matrix_long_double_superdiagonal(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<long double >::vector_type
  matrix<long double >::diagonal(int i) const
  {
    if (i == 0)     
      return vector_type(gsl_matrix_long_double_diagonal(_matrix));
    else if (i < 0) 
  ...
  //__________________________________________________________________
  inline matrix<long double >::vector_type
  matrix<long double >::sub_diagonal(int i)
  {
    return diagonal(-i);
  }
  //__________________________________________________________________
  inline const matrix<long double >::vector_type
  matrix<long double >::sub_diagonal(int i) const
  {
    return diagonal(-i);
  }
  //__________________________________________________________________
  inline matrix<long double >::vector_type
  matrix<long double >::super_diagonal(int i)
  {
    return diagonal(i);
  }
  //__________________________________________________________________
  inline const matrix<long double >::vector_type
  matrix<long double >::super_diagonal(int i) const
  {
    return diagonal(i);
  }
  //__________________________________________________________________
  ...
  matrix<long double >::operator*=(const matrix<value_type>& m)
  {
    gsl_matrix_long_double_mul_elements(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<long double >&
  matrix<long double >::operator/=(const matrix<value_type>& m)
  {
    gsl_matrix_long_double_div_elements(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<long double >&
  matrix<long double >::operator+=(const matrix<value_type>& m)
  {
    gsl_matrix_long_double_add(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<long double >&
  matrix<long double >::operator-=(const matrix<value_type>& m)
  {
    gsl_matrix_long_double_sub(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<long double >&
  matrix<long double >::operator+=(const value_type& x)
  {
    gsl_matrix_long_double_add_constant(_matrix,x);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<long double >&
  ...
  matrix<long double >::operator*=(const value_type& x)
  {
    gsl_matrix_long_double_scale(_matrix,x);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<long double >&
  ...
  //__________________________________________________________________
  inline 
  matrix<long double >::value_type
  matrix<long double >::min() const 
  {
    return gsl_matrix_long_double_min(_matrix);
  }
  //__________________________________________________________________
  inline 
  matrix<long double >::value_type
  matrix<long double >::max() const 
  {
    return gsl_matrix_long_double_max(_matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<long double >::minmax(value_type& min, value_type& max) const 
  {
    return gsl_matrix_long_double_minmax(_matrix, &min, &max);
  }
  //__________________________________________________________________
  inline void
  matrix<long double >::min_index(iterator& row, iterator& column) const 
  {
    gsl_matrix_long_double_min_index(_matrix, &row, &column);
  }
  //__________________________________________________________________
  inline void
  matrix<long double >::max_index(iterator& row, iterator& column) const 
  {
    gsl_matrix_long_double_max_index(_matrix, &row, &column);
  }
  //__________________________________________________________________
  inline void
  matrix<long double >::minmax_index(iterator& min_row, iterator& min_column,
			       iterator& max_row, iterator& max_column) 
    const 
  {
    gsl_matrix_long_double_minmax_index(_matrix, &min_row, &min_column,
					  &max_row, &max_column);
  }
#endif
}
