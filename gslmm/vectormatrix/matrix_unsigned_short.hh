...
//          options: @skel@, unsigned short .  
//          Do not edit this file.
//
//  gslmm::matrix_unsigned_short
...
#define GSLMM_matrix_unsigned_short
#line 29 "matrix_skel.hh"
/** @file   matrix_unsigned_short.hh
    @author Christian Holm
    @date   Mon Mar 10 14:50:12 2003
    @brief  @c unsigned short  specialisation of matrix class */
...
#endif
#ifndef GSLMM_vectormatrix_vector_unsigned_short
...
namespace gslmm
{
  /** @brief Matrix @c unsigned short  specialisation.
      @ingroup matrix
   */
  template <>
  ...
  public:
    ...
    /** Low level data type */
    typedef gsl_matrix_ushort data_type;
    /** Low level view type */
    typedef gsl_matrix_ushort_view view_type;
    ...
    matrix<unsigned short > operator()(iterator row, iterator column, 
...
namespace gslmm
{
  ...
  inline matrix<unsigned short >::matrix(oper_type p) 
    : _matrix(0)
  {
    assert(p.get());
    if (!p.get()) GSL_ERROR_VOID("NULL return passed", GSL_EINVAL);
    _matrix = gsl_matrix_ushort_calloc(p->row_size(), p->column_size());
    p->operator()(*this);
    // delete p;
    // p = 0;
  }
  ...
  //__________________________________________________________________
  inline matrix<unsigned short >::matrix(size_t rows, size_t columns, bool zero) 
    : _matrix(0)
  {
    if (zero) _matrix = gsl_matrix_ushort_calloc(rows, columns);
    else      _matrix = gsl_matrix_ushort_alloc(rows, columns);
  }
  //__________________________________________________________________
  inline matrix<unsigned short >::matrix(const matrix<value_type>& m,
				bool trans
#if 0
				, bool conj
#endif
  ...
  {
    if (!trans) {
      _matrix = gsl_matrix_ushort_alloc(m.row_size(), m.column_size());
      *this = m;
    }
    else {
      _matrix = gsl_matrix_ushort_alloc(m.column_size(), m.row_size());
      gsl_matrix_ushort_transpose_memcpy(_matrix,m._matrix);
    }
#if 0
    if (conj) conjugate();
#endif
  ...
  //__________________________________________________________________
  inline 
  matrix<unsigned short >::matrix(const matrix<value_type>& m, 
			 iterator row_offset, iterator column_offset, 
			 size_type rows, size_type columns, 
			 size_type) 
    : _matrix(0)
  {
    view_type v = gsl_matrix_ushort_submatrix(m._matrix,
					    row_offset, 
					    column_offset,
					    rows, columns);
    from_view(v);
  ...
  //__________________________________________________________________
  inline matrix<unsigned short >::matrix(element_type* array, 
				size_type rows, size_type columns, 
				size_type tda) 
    : _matrix(0)
  {
    view_type v;
    if (tda <= 0)
      v = gsl_matrix_ushort_view_array(array, rows, columns);
    else 
      v = gsl_matrix_ushort_view_array_with_tda(array, rows, columns, tda);
    from_view(v);
  }
  //__________________________________________________________________
  inline 
  matrix<unsigned short >::matrix(const vector_type& vec,
			 size_type rows, size_type columns, 
			 size_type tda) 
     : _matrix(0)
 {
    view_type v;
    if (tda <= 0)
      v = gsl_matrix_ushort_view_vector(vec._vector, rows, columns);
    else 
      v = gsl_matrix_ushort_view_vector_with_tda(vec._vector, rows, 
							columns, tda);
    from_view(v);
  }
  
  //__________________________________________________________________
  inline matrix<unsigned short >::~matrix()
  {
    gsl_matrix_ushort_free(_matrix);
  }
  //__________________________________________________________________
  inline void matrix<unsigned short >::from_view(view_type& v)
  {
  ...
  matrix<unsigned short >::operator=(const matrix<value_type>& m)
  {
    gsl_matrix_ushort_memcpy(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<unsigned short >&
  matrix<unsigned short >::operator=(oper_type p)
  {
    assert(p.get());
  ...
  //__________________________________________________________________
  inline void
  matrix<unsigned short >::swap(const matrix<value_type>& m)
  {
    gsl_matrix_ushort_swap(_matrix,m._matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<unsigned short >::swap_rows(iterator i, iterator j)
  {
    gsl_matrix_ushort_swap_rows(_matrix,i, j);
  }
  //__________________________________________________________________
  inline void
  matrix<unsigned short >::swap_columns(iterator i, iterator j)
  {
    gsl_matrix_ushort_swap_columns(_matrix,i, j);
  }
  //__________________________________________________________________
  inline void
  matrix<unsigned short >::swap_row_column(iterator i, iterator j)
  {
    gsl_matrix_ushort_swap_rowcol(_matrix,i, j);
  }
  //__________________________________________________________________
  inline bool
  matrix<unsigned short >::is_owner()  const
  {
    return _matrix->owner == 1;
  }
  //__________________________________________________________________
  inline bool
  matrix<unsigned short >::is_null()  const 
  {
    return gsl_matrix_ushort_isnull(_matrix) == 1;
  }
  //__________________________________________________________________
  inline void
  matrix<unsigned short >::zero() 
  {
    gsl_matrix_ushort_set_zero(_matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<unsigned short >::set(value_type x) 
  {
    gsl_matrix_ushort_set_all(_matrix, x);
  }
  //__________________________________________________________________
  inline void
  matrix<unsigned short >::identity()
  {
    gsl_matrix_ushort_set_identity(_matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<unsigned short >::transpose()
  {
    gsl_matrix_ushort_transpose(_matrix);
  }
  //__________________________________________________________________
  inline matrix<unsigned short >
  matrix<unsigned short >::operator()(iterator i, iterator j, size_type n1, 
				   size_type n2) const
  {
    return matrix<unsigned short >(*this, i, j, n1, n2);
  }
  //__________________________________________________________________
  inline 
  const matrix<unsigned short >::reference_type
  matrix<unsigned short >::operator()(iterator i, iterator j) const 
  {
#if 0
    return reference_type(gsl_matrix_ushort_ptr(_matrix, i, j));
#else 
    return reference_type(*(gsl_matrix_ushort_ptr(_matrix, i, j)));
#endif
  }
  //__________________________________________________________________
  inline 
  matrix<unsigned short >::reference_type
  matrix<unsigned short >::operator()(iterator i, iterator j) 
  {
#if 0
    return reference_type(gsl_matrix_ushort_ptr(_matrix, i, j));
#else 
  ...
  //__________________________________________________________________
  inline matrix<unsigned short >::vector_type
  matrix<unsigned short >::operator[](iterator i)
  {
    // Must be implemented here - temporary
    return vector_type(gsl_matrix_ushort_row(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<unsigned short >::vector_type
  matrix<unsigned short >::operator[](iterator i) const
  {
    // Must be implemented here - temporary
    return vector_type(gsl_matrix_ushort_row(_matrix,i));
  }
  //__________________________________________________________________
  inline matrix<unsigned short >::value_type*
  matrix<unsigned short >::element(iterator row, iterator column) 
  {
    // Must be implemented here - temporary
    
    return (value_type*)(gsl_matrix_ushort_ptr(_matrix,row, column));
  }
  //__________________________________________________________________
  inline const matrix<unsigned short >::value_type*
  matrix<unsigned short >::element(iterator row, iterator column) const
  {
    // Must be implemented here - temporary
    return (value_type*)(gsl_matrix_ushort_const_ptr(_matrix,row, column));
  }
  //__________________________________________________________________
  inline matrix<unsigned short >::vector_type
  matrix<unsigned short >::row(iterator i)
  {
    return vector_type(gsl_matrix_ushort_row(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<unsigned short >::vector_type
  matrix<unsigned short >::row(iterator i) const
  {
    return vector_type(gsl_matrix_ushort_row(_matrix,i));
  }
  //__________________________________________________________________
  inline matrix<unsigned short >::vector_type
  matrix<unsigned short >::column(iterator i)
  {
    return vector_type(gsl_matrix_ushort_column(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<unsigned short >::vector_type
  matrix<unsigned short >::column(iterator i) const
  {
    return vector_type(gsl_matrix_ushort_column(_matrix,i));
  }
  //__________________________________________________________________
  inline matrix<unsigned short >::vector_type
  matrix<unsigned short >::diagonal(int i)
  {
    if (i == 0)     
      return vector_type(gsl_matrix_ushort_diagonal(_matrix));
    else if (i < 0) 
      return 
	vector_type(gsl_matrix_ushort_subdiagonal(_matrix,-i));
    return 
      vector_type(gsl_matrix_ushort_superdiagonal(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<unsigned short >::vector_type
  matrix<unsigned short >::diagonal(int i) const
  {
    if (i == 0)     
      return vector_type(gsl_matrix_ushort_diagonal(_matrix));
    else if (i < 0) 
  ...
  //__________________________________________________________________
  inline matrix<unsigned short >::vector_type
  matrix<unsigned short >::sub_diagonal(int i)
  {
    return diagonal(-i);
  }
  //__________________________________________________________________
  inline const matrix<unsigned short >::vector_type
  matrix<unsigned short >::sub_diagonal(int i) const
  {
    return diagonal(-i);
  }
  //__________________________________________________________________
  inline matrix<unsigned short >::vector_type
  matrix<unsigned short >::super_diagonal(int i)
  {
    return diagonal(i);
  }
  //__________________________________________________________________
  inline const matrix<unsigned short >::vector_type
  matrix<unsigned short >::super_diagonal(int i) const
  {
    return diagonal(i);
  }
  //__________________________________________________________________
  ...
  matrix<unsigned short >::operator*=(const matrix<value_type>& m)
  {
    gsl_matrix_ushort_mul_elements(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<unsigned short >&
  matrix<unsigned short >::operator/=(const matrix<value_type>& m)
  {
    gsl_matrix_ushort_div_elements(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<unsigned short >&
  matrix<unsigned short >::operator+=(const matrix<value_type>& m)
  {
    gsl_matrix_ushort_add(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<unsigned short >&
  matrix<unsigned short >::operator-=(const matrix<value_type>& m)
  {
    gsl_matrix_ushort_sub(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<unsigned short >&
  matrix<unsigned short >::operator+=(const value_type& x)
  {
    gsl_matrix_ushort_add_constant(_matrix,x);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<unsigned short >&
  ...
  matrix<unsigned short >::operator*=(const value_type& x)
  {
    gsl_matrix_ushort_scale(_matrix,x);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<unsigned short >&
  ...
  inline 
  void
  matrix<unsigned short >::conjugate() 
  {
  ...
  //__________________________________________________________________
  inline 
  matrix<unsigned short >::value_type
  matrix<unsigned short >::min() const 
  {
    return gsl_matrix_ushort_min(_matrix);
  }
  //__________________________________________________________________
  inline 
  matrix<unsigned short >::value_type
  matrix<unsigned short >::max() const 
  {
    return gsl_matrix_ushort_max(_matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<unsigned short >::minmax(value_type& min, value_type& max) const 
  {
    return gsl_matrix_ushort_minmax(_matrix, &min, &max);
  }
  //__________________________________________________________________
  inline void
  matrix<unsigned short >::min_index(iterator& row, iterator& column) const 
  {
    gsl_matrix_ushort_min_index(_matrix, &row, &column);
  }
  //__________________________________________________________________
  inline void
  matrix<unsigned short >::max_index(iterator& row, iterator& column) const 
  {
    gsl_matrix_ushort_max_index(_matrix, &row, &column);
  }
  //__________________________________________________________________
  inline void
  matrix<unsigned short >::minmax_index(iterator& min_row, iterator& min_column,
			       iterator& max_row, iterator& max_column) 
    const 
  {
    gsl_matrix_ushort_minmax_index(_matrix, &min_row, &min_column,
					  &max_row, &max_column);
  }
#endif
}
