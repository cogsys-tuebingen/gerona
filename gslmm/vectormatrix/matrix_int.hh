...
#define GSLMM_matrix_int
#line 29 "matrix_skel.hh"
/** @file   matrix_int.hh
    @author Christian Holm
    @date   Mon Mar 10 14:50:12 2003
    @brief  @c int  specialisation of matrix class */
...
#endif
#ifndef GSLMM_vectormatrix_vector_int
...
namespace gslmm
{
  /** @brief Matrix @c int  specialisation.
      @ingroup matrix
   */
  template <>
  class matrix<int >
  ...
  public:
    ...
    /** Low level data type */
    typedef gsl_matrix_int data_type;
    /** Low level view type */
    typedef gsl_matrix_int_view view_type;
    ...
    matrix<int > operator()(iterator row, iterator column, 
...
namespace gslmm
{
  ...
  inline matrix<int >::matrix(oper_type p) 
    : _matrix(0)
  {
    assert(p.get());
    if (!p.get()) GSL_ERROR_VOID("NULL return passed", GSL_EINVAL);
    _matrix = gsl_matrix_int_calloc(p->row_size(), p->column_size());
    p->operator()(*this);
    // delete p;
    // p = 0;
  }
  ...
  //__________________________________________________________________
  inline matrix<int >::matrix(size_t rows, size_t columns, bool zero) 
    : _matrix(0)
  {
    if (zero) _matrix = gsl_matrix_int_calloc(rows, columns);
    else      _matrix = gsl_matrix_int_alloc(rows, columns);
  }
  //__________________________________________________________________
  inline matrix<int >::matrix(const matrix<value_type>& m,
				bool trans
#if 0
				, bool conj
#endif
  ...
  {
    if (!trans) {
      _matrix = gsl_matrix_int_alloc(m.row_size(), m.column_size());
      *this = m;
    }
    else {
      _matrix = gsl_matrix_int_alloc(m.column_size(), m.row_size());
      gsl_matrix_int_transpose_memcpy(_matrix,m._matrix);
    }
#if 0
    if (conj) conjugate();
#endif
  ...
  //__________________________________________________________________
  inline 
  matrix<int >::matrix(const matrix<value_type>& m, 
			 iterator row_offset, iterator column_offset, 
			 size_type rows, size_type columns, 
			 size_type) 
    : _matrix(0)
  {
    view_type v = gsl_matrix_int_submatrix(m._matrix,
					    row_offset, 
					    column_offset,
					    rows, columns);
    from_view(v);
  ...
  //__________________________________________________________________
  inline matrix<int >::matrix(element_type* array, 
				size_type rows, size_type columns, 
				size_type tda) 
    : _matrix(0)
  {
    view_type v;
    if (tda <= 0)
      v = gsl_matrix_int_view_array(array, rows, columns);
    else 
      v = gsl_matrix_int_view_array_with_tda(array, rows, columns, tda);
    from_view(v);
  }
  //__________________________________________________________________
  inline 
  matrix<int >::matrix(const vector_type& vec,
			 size_type rows, size_type columns, 
			 size_type tda) 
     : _matrix(0)
 {
    view_type v;
    if (tda <= 0)
      v = gsl_matrix_int_view_vector(vec._vector, rows, columns);
    else 
      v = gsl_matrix_int_view_vector_with_tda(vec._vector, rows, 
							columns, tda);
    from_view(v);
  }
  ...
  {
    gsl_matrix_int_free(_matrix);
  }
  //__________________________________________________________________
  inline void matrix<int >::from_view(view_type& v)
  {
  ...
  //__________________________________________________________________
  inline matrix<int >&
  matrix<int >::operator=(const matrix<value_type>& m)
  {
    gsl_matrix_int_memcpy(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<int >&
  matrix<int >::operator=(oper_type p)
  {
    assert(p.get());
  ...
  //__________________________________________________________________
  inline void
  matrix<int >::swap(const matrix<value_type>& m)
  {
    gsl_matrix_int_swap(_matrix,m._matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<int >::swap_rows(iterator i, iterator j)
  {
    gsl_matrix_int_swap_rows(_matrix,i, j);
  }
  //__________________________________________________________________
  inline void
  matrix<int >::swap_columns(iterator i, iterator j)
  {
    gsl_matrix_int_swap_columns(_matrix,i, j);
  }
  //__________________________________________________________________
  inline void
  matrix<int >::swap_row_column(iterator i, iterator j)
  {
    gsl_matrix_int_swap_rowcol(_matrix,i, j);
  }
  //__________________________________________________________________
  inline bool
  matrix<int >::is_owner()  const
  {
    return _matrix->owner == 1;
  }
  //__________________________________________________________________
  inline bool
  matrix<int >::is_null()  const 
  {
    return gsl_matrix_int_isnull(_matrix) == 1;
  }
  //__________________________________________________________________
  inline void
  matrix<int >::zero() 
  {
    gsl_matrix_int_set_zero(_matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<int >::set(value_type x) 
  {
    gsl_matrix_int_set_all(_matrix, x);
  }
  //__________________________________________________________________
  inline void
  matrix<int >::identity()
  {
    gsl_matrix_int_set_identity(_matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<int >::transpose()
  {
    gsl_matrix_int_transpose(_matrix);
  }
  //__________________________________________________________________
  inline matrix<int >
  matrix<int >::operator()(iterator i, iterator j, size_type n1, 
				   size_type n2) const
  {
    return matrix<int >(*this, i, j, n1, n2);
  }
  //__________________________________________________________________
  inline 
  const matrix<int >::reference_type
  matrix<int >::operator()(iterator i, iterator j) const 
  {
#if 0
    return reference_type(gsl_matrix_int_ptr(_matrix, i, j));
#else 
    return reference_type(*(gsl_matrix_int_ptr(_matrix, i, j)));
#endif
  }
  //__________________________________________________________________
  inline 
  matrix<int >::reference_type
  matrix<int >::operator()(iterator i, iterator j) 
  {
#if 0
    return reference_type(gsl_matrix_int_ptr(_matrix, i, j));
#else 
  ...
  //__________________________________________________________________
  inline matrix<int >::vector_type
  matrix<int >::operator[](iterator i)
  {
    // Must be implemented here - temporary
    return vector_type(gsl_matrix_int_row(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<int >::vector_type
  matrix<int >::operator[](iterator i) const
  {
    // Must be implemented here - temporary
    return vector_type(gsl_matrix_int_row(_matrix,i));
  }
  //__________________________________________________________________
  inline matrix<int >::value_type*
  matrix<int >::element(iterator row, iterator column) 
  {
    // Must be implemented here - temporary
    
    return (value_type*)(gsl_matrix_int_ptr(_matrix,row, column));
  }
  //__________________________________________________________________
  inline const matrix<int >::value_type*
  matrix<int >::element(iterator row, iterator column) const
  {
    // Must be implemented here - temporary
    return (value_type*)(gsl_matrix_int_const_ptr(_matrix,row, column));
  }
  //__________________________________________________________________
  inline matrix<int >::vector_type
  matrix<int >::row(iterator i)
  {
    return vector_type(gsl_matrix_int_row(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<int >::vector_type
  matrix<int >::row(iterator i) const
  {
    return vector_type(gsl_matrix_int_row(_matrix,i));
  }
  //__________________________________________________________________
  inline matrix<int >::vector_type
  matrix<int >::column(iterator i)
  {
    return vector_type(gsl_matrix_int_column(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<int >::vector_type
  matrix<int >::column(iterator i) const
  {
    return vector_type(gsl_matrix_int_column(_matrix,i));
  }
  //__________________________________________________________________
  inline matrix<int >::vector_type
  matrix<int >::diagonal(int i)
  {
    if (i == 0)     
      return vector_type(gsl_matrix_int_diagonal(_matrix));
    else if (i < 0) 
      return 
	vector_type(gsl_matrix_int_subdiagonal(_matrix,-i));
    return 
      vector_type(gsl_matrix_int_superdiagonal(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<int >::vector_type
  matrix<int >::diagonal(int i) const
  {
    if (i == 0)     
      return vector_type(gsl_matrix_int_diagonal(_matrix));
    else if (i < 0) 
  ...
  //__________________________________________________________________
  inline matrix<int >::vector_type
  matrix<int >::sub_diagonal(int i)
  {
    return diagonal(-i);
  }
  //__________________________________________________________________
  inline const matrix<int >::vector_type
  matrix<int >::sub_diagonal(int i) const
  {
    return diagonal(-i);
  }
  //__________________________________________________________________
  inline matrix<int >::vector_type
  matrix<int >::super_diagonal(int i)
  {
    return diagonal(i);
  }
  //__________________________________________________________________
  inline const matrix<int >::vector_type
  matrix<int >::super_diagonal(int i) const
  {
    return diagonal(i);
  }
  //__________________________________________________________________
  ...
  matrix<int >::operator*=(const matrix<value_type>& m)
  {
    gsl_matrix_int_mul_elements(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<int >&
  matrix<int >::operator/=(const matrix<value_type>& m)
  {
    gsl_matrix_int_div_elements(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<int >&
  matrix<int >::operator+=(const matrix<value_type>& m)
  {
    gsl_matrix_int_add(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<int >&
  matrix<int >::operator-=(const matrix<value_type>& m)
  {
    gsl_matrix_int_sub(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<int >&
  matrix<int >::operator+=(const value_type& x)
  {
    gsl_matrix_int_add_constant(_matrix,x);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<int >&
  ...
  matrix<int >::operator*=(const value_type& x)
  {
    gsl_matrix_int_scale(_matrix,x);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<int >&
  ...
  //__________________________________________________________________
  inline 
  matrix<int >::value_type
  matrix<int >::min() const 
  {
    return gsl_matrix_int_min(_matrix);
  }
  //__________________________________________________________________
  inline 
  matrix<int >::value_type
  matrix<int >::max() const 
  {
    return gsl_matrix_int_max(_matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<int >::minmax(value_type& min, value_type& max) const 
  {
    return gsl_matrix_int_minmax(_matrix, &min, &max);
  }
  //__________________________________________________________________
  inline void
  matrix<int >::min_index(iterator& row, iterator& column) const 
  {
    gsl_matrix_int_min_index(_matrix, &row, &column);
  }
  //__________________________________________________________________
  inline void
  matrix<int >::max_index(iterator& row, iterator& column) const 
  {
    gsl_matrix_int_max_index(_matrix, &row, &column);
  }
  //__________________________________________________________________
  inline void
  matrix<int >::minmax_index(iterator& min_row, iterator& min_column,
			       iterator& max_row, iterator& max_column) 
    const 
  {
    gsl_matrix_int_minmax_index(_matrix, &min_row, &min_column,
					  &max_row, &max_column);
  }
#endif
}
