...
#define GSLMM_matrix_char
#line 29 "matrix_skel.hh"
/** @file   matrix_char.hh
    @author Christian Holm
    @date   Mon Mar 10 14:50:12 2003
    @brief  @c char  specialisation of matrix class */
...
#endif
#ifndef GSLMM_vectormatrix_vector_char
...
namespace gslmm
{
  /** @brief Matrix @c char  specialisation.
      @ingroup matrix
   */
  template <>
  class matrix<char >
  ...
  public:
    ...
    /** Low level data type */
    typedef gsl_matrix_char data_type;
    /** Low level view type */
    typedef gsl_matrix_char_view view_type;
    ...
    matrix<char > operator()(iterator row, iterator column, 
...
namespace gslmm
{
  ...
  inline matrix<char >::matrix(oper_type p) 
    : _matrix(0)
  {
    assert(p.get());
    if (!p.get()) GSL_ERROR_VOID("NULL return passed", GSL_EINVAL);
    _matrix = gsl_matrix_char_calloc(p->row_size(), p->column_size());
    p->operator()(*this);
    // delete p;
    // p = 0;
  }
  ...
  //__________________________________________________________________
  inline matrix<char >::matrix(size_t rows, size_t columns, bool zero) 
    : _matrix(0)
  {
    if (zero) _matrix = gsl_matrix_char_calloc(rows, columns);
    else      _matrix = gsl_matrix_char_alloc(rows, columns);
  }
  //__________________________________________________________________
  inline matrix<char >::matrix(const matrix<value_type>& m,
				bool trans
#if 0
				, bool conj
#endif
  ...
  {
    if (!trans) {
      _matrix = gsl_matrix_char_alloc(m.row_size(), m.column_size());
      *this = m;
    }
    else {
      _matrix = gsl_matrix_char_alloc(m.column_size(), m.row_size());
      gsl_matrix_char_transpose_memcpy(_matrix,m._matrix);
    }
#if 0
    if (conj) conjugate();
#endif
  ...
  //__________________________________________________________________
  inline 
  matrix<char >::matrix(const matrix<value_type>& m, 
			 iterator row_offset, iterator column_offset, 
			 size_type rows, size_type columns, 
			 size_type) 
    : _matrix(0)
  {
    view_type v = gsl_matrix_char_submatrix(m._matrix,
					    row_offset, 
					    column_offset,
					    rows, columns);
    from_view(v);
  ...
  //__________________________________________________________________
  inline matrix<char >::matrix(element_type* array, 
				size_type rows, size_type columns, 
				size_type tda) 
    : _matrix(0)
  {
    view_type v;
    if (tda <= 0)
      v = gsl_matrix_char_view_array(array, rows, columns);
    else 
      v = gsl_matrix_char_view_array_with_tda(array, rows, columns, tda);
    from_view(v);
  }
  //__________________________________________________________________
  inline 
  matrix<char >::matrix(const vector_type& vec,
			 size_type rows, size_type columns, 
			 size_type tda) 
     : _matrix(0)
 {
    view_type v;
    if (tda <= 0)
      v = gsl_matrix_char_view_vector(vec._vector, rows, columns);
    else 
      v = gsl_matrix_char_view_vector_with_tda(vec._vector, rows, 
							columns, tda);
    from_view(v);
  }
  
  //__________________________________________________________________
  inline matrix<char >::~matrix()
  {
    gsl_matrix_char_free(_matrix);
  }
  //__________________________________________________________________
  inline void matrix<char >::from_view(view_type& v)
  {
  ...
  //__________________________________________________________________
  inline matrix<char >&
  matrix<char >::operator=(const matrix<value_type>& m)
  {
    gsl_matrix_char_memcpy(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<char >&
  matrix<char >::operator=(oper_type p)
  {
    assert(p.get());
  ...
  //__________________________________________________________________
  inline void
  matrix<char >::swap(const matrix<value_type>& m)
  {
    gsl_matrix_char_swap(_matrix,m._matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<char >::swap_rows(iterator i, iterator j)
  {
    gsl_matrix_char_swap_rows(_matrix,i, j);
  }
  //__________________________________________________________________
  inline void
  matrix<char >::swap_columns(iterator i, iterator j)
  {
    gsl_matrix_char_swap_columns(_matrix,i, j);
  }
  //__________________________________________________________________
  inline void
  matrix<char >::swap_row_column(iterator i, iterator j)
  {
    gsl_matrix_char_swap_rowcol(_matrix,i, j);
  }
  //__________________________________________________________________
  inline bool
  matrix<char >::is_owner()  const
  {
    return _matrix->owner == 1;
  }
  //__________________________________________________________________
  inline bool
  matrix<char >::is_null()  const 
  {
    return gsl_matrix_char_isnull(_matrix) == 1;
  }
  //__________________________________________________________________
  inline void
  matrix<char >::zero() 
  {
    gsl_matrix_char_set_zero(_matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<char >::set(value_type x) 
  {
    gsl_matrix_char_set_all(_matrix, x);
  }
  //__________________________________________________________________
  inline void
  matrix<char >::identity()
  {
    gsl_matrix_char_set_identity(_matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<char >::transpose()
  {
    gsl_matrix_char_transpose(_matrix);
  }
  //__________________________________________________________________
  inline matrix<char >
  matrix<char >::operator()(iterator i, iterator j, size_type n1, 
				   size_type n2) const
  {
    return matrix<char >(*this, i, j, n1, n2);
  }
  //__________________________________________________________________
  inline 
  const matrix<char >::reference_type
  matrix<char >::operator()(iterator i, iterator j) const 
  {
#if 0
    return reference_type(gsl_matrix_char_ptr(_matrix, i, j));
#else 
    return reference_type(*(gsl_matrix_char_ptr(_matrix, i, j)));
#endif
  }
  //__________________________________________________________________
  inline 
  matrix<char >::reference_type
  matrix<char >::operator()(iterator i, iterator j) 
  {
#if 0
    return reference_type(gsl_matrix_char_ptr(_matrix, i, j));
#else 
  ...
  //__________________________________________________________________
  inline matrix<char >::vector_type
  matrix<char >::operator[](iterator i)
  {
    // Must be implemented here - temporary
    return vector_type(gsl_matrix_char_row(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<char >::vector_type
  matrix<char >::operator[](iterator i) const
  {
    // Must be implemented here - temporary
    return vector_type(gsl_matrix_char_row(_matrix,i));
  }
  //__________________________________________________________________
  inline matrix<char >::value_type*
  matrix<char >::element(iterator row, iterator column) 
  {
    // Must be implemented here - temporary
    
    return (value_type*)(gsl_matrix_char_ptr(_matrix,row, column));
  }
  //__________________________________________________________________
  inline const matrix<char >::value_type*
  matrix<char >::element(iterator row, iterator column) const
  {
    // Must be implemented here - temporary
    return (value_type*)(gsl_matrix_char_const_ptr(_matrix,row, column));
  }
  //__________________________________________________________________
  inline matrix<char >::vector_type
  matrix<char >::row(iterator i)
  {
    return vector_type(gsl_matrix_char_row(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<char >::vector_type
  matrix<char >::row(iterator i) const
  {
    return vector_type(gsl_matrix_char_row(_matrix,i));
  }
  //__________________________________________________________________
  inline matrix<char >::vector_type
  matrix<char >::column(iterator i)
  {
    return vector_type(gsl_matrix_char_column(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<char >::vector_type
  matrix<char >::column(iterator i) const
  {
    return vector_type(gsl_matrix_char_column(_matrix,i));
  }
  //__________________________________________________________________
  inline matrix<char >::vector_type
  matrix<char >::diagonal(int i)
  {
    if (i == 0)     
      return vector_type(gsl_matrix_char_diagonal(_matrix));
    else if (i < 0) 
      return 
	vector_type(gsl_matrix_char_subdiagonal(_matrix,-i));
    return 
      vector_type(gsl_matrix_char_superdiagonal(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<char >::vector_type
  matrix<char >::diagonal(int i) const
  {
    if (i == 0)     
      return vector_type(gsl_matrix_char_diagonal(_matrix));
    else if (i < 0) 
  ...
  //__________________________________________________________________
  inline matrix<char >::vector_type
  matrix<char >::sub_diagonal(int i)
  {
    return diagonal(-i);
  }
  //__________________________________________________________________
  inline const matrix<char >::vector_type
  matrix<char >::sub_diagonal(int i) const
  {
    return diagonal(-i);
  }
  //__________________________________________________________________
  inline matrix<char >::vector_type
  matrix<char >::super_diagonal(int i)
  {
    return diagonal(i);
  }
  //__________________________________________________________________
  inline const matrix<char >::vector_type
  matrix<char >::super_diagonal(int i) const
  {
    return diagonal(i);
  }
  //__________________________________________________________________
  ...
  matrix<char >::operator*=(const matrix<value_type>& m)
  {
    gsl_matrix_char_mul_elements(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<char >&
  matrix<char >::operator/=(const matrix<value_type>& m)
  {
    gsl_matrix_char_div_elements(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<char >&
  matrix<char >::operator+=(const matrix<value_type>& m)
  {
    gsl_matrix_char_add(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<char >&
  matrix<char >::operator-=(const matrix<value_type>& m)
  {
    gsl_matrix_char_sub(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<char >&
  matrix<char >::operator+=(const value_type& x)
  {
    gsl_matrix_char_add_constant(_matrix,x);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<char >&
  ...
  matrix<char >::operator*=(const value_type& x)
  {
    gsl_matrix_char_scale(_matrix,x);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<char >&
  ...
  //__________________________________________________________________
  inline 
  matrix<char >::value_type
  matrix<char >::min() const 
  {
    return gsl_matrix_char_min(_matrix);
  }
  //__________________________________________________________________
  inline 
  matrix<char >::value_type
  matrix<char >::max() const 
  {
    return gsl_matrix_char_max(_matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<char >::minmax(value_type& min, value_type& max) const 
  {
    return gsl_matrix_char_minmax(_matrix, &min, &max);
  }
  //__________________________________________________________________
  inline void
  matrix<char >::min_index(iterator& row, iterator& column) const 
  {
    gsl_matrix_char_min_index(_matrix, &row, &column);
  }
  //__________________________________________________________________
  inline void
  matrix<char >::max_index(iterator& row, iterator& column) const 
  {
    gsl_matrix_char_max_index(_matrix, &row, &column);
  }
  //__________________________________________________________________
  inline void
  matrix<char >::minmax_index(iterator& min_row, iterator& min_column,
			       iterator& max_row, iterator& max_column) 
    const 
  {
    gsl_matrix_char_minmax_index(_matrix, &min_row, &min_column,
					  &max_row, &max_column);
  }
#endif
}
