...
#define GSLMM_matrix_long
#line 29 "matrix_skel.hh"
/** @file   matrix_long.hh
    @author Christian Holm
    @date   Mon Mar 10 14:50:12 2003
    @brief  @c long  specialisation of matrix class */
...
#endif
#ifndef GSLMM_vectormatrix_vector_long
...
namespace gslmm
{
  /** @brief Matrix @c long  specialisation.
      @ingroup matrix
   */
  template <>
  class matrix<long >
  ...
  public:
    ...
    /** Low level data type */
    typedef gsl_matrix_long data_type;
    /** Low level view type */
    typedef gsl_matrix_long_view view_type;
    ...
    matrix<long > operator()(iterator row, iterator column, 
...
namespace gslmm
{
  ...
  inline matrix<long >::matrix(oper_type p) 
    : _matrix(0)
  {
    assert(p.get());
    if (!p.get()) GSL_ERROR_VOID("NULL return passed", GSL_EINVAL);
    _matrix = gsl_matrix_long_calloc(p->row_size(), p->column_size());
    p->operator()(*this);
    // delete p;
    // p = 0;
  }
  ...
  //__________________________________________________________________
  inline matrix<long >::matrix(size_t rows, size_t columns, bool zero) 
    : _matrix(0)
  {
    if (zero) _matrix = gsl_matrix_long_calloc(rows, columns);
    else      _matrix = gsl_matrix_long_alloc(rows, columns);
  }
  //__________________________________________________________________
  inline matrix<long >::matrix(const matrix<value_type>& m,
				bool trans
#if 0
				, bool conj
#endif
  ...
  {
    if (!trans) {
      _matrix = gsl_matrix_long_alloc(m.row_size(), m.column_size());
      *this = m;
    }
    else {
      _matrix = gsl_matrix_long_alloc(m.column_size(), m.row_size());
      gsl_matrix_long_transpose_memcpy(_matrix,m._matrix);
    }
#if 0
    if (conj) conjugate();
#endif
  ...
  //__________________________________________________________________
  inline 
  matrix<long >::matrix(const matrix<value_type>& m, 
			 iterator row_offset, iterator column_offset, 
			 size_type rows, size_type columns, 
			 size_type) 
    : _matrix(0)
  {
    view_type v = gsl_matrix_long_submatrix(m._matrix,
					    row_offset, 
					    column_offset,
					    rows, columns);
    from_view(v);
  ...
  //__________________________________________________________________
  inline matrix<long >::matrix(element_type* array, 
				size_type rows, size_type columns, 
				size_type tda) 
    : _matrix(0)
  {
    view_type v;
    if (tda <= 0)
      v = gsl_matrix_long_view_array(array, rows, columns);
    else 
      v = gsl_matrix_long_view_array_with_tda(array, rows, columns, tda);
    from_view(v);
  }
  //__________________________________________________________________
  inline 
  matrix<long >::matrix(const vector_type& vec,
			 size_type rows, size_type columns, 
			 size_type tda) 
     : _matrix(0)
 {
    view_type v;
    if (tda <= 0)
      v = gsl_matrix_long_view_vector(vec._vector, rows, columns);
    else 
      v = gsl_matrix_long_view_vector_with_tda(vec._vector, rows, 
							columns, tda);
    from_view(v);
  }
  
  //__________________________________________________________________
  inline matrix<long >::~matrix()
  {
    gsl_matrix_long_free(_matrix);
  }
  //__________________________________________________________________
  inline void matrix<long >::from_view(view_type& v)
  {
  ...
  //__________________________________________________________________
  inline matrix<long >&
  matrix<long >::operator=(const matrix<value_type>& m)
  {
    gsl_matrix_long_memcpy(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<long >&
  matrix<long >::operator=(oper_type p)
  {
    assert(p.get());
  ...
  //__________________________________________________________________
  inline void
  matrix<long >::swap(const matrix<value_type>& m)
  {
    gsl_matrix_long_swap(_matrix,m._matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<long >::swap_rows(iterator i, iterator j)
  {
    gsl_matrix_long_swap_rows(_matrix,i, j);
  }
  //__________________________________________________________________
  inline void
  matrix<long >::swap_columns(iterator i, iterator j)
  {
    gsl_matrix_long_swap_columns(_matrix,i, j);
  }
  //__________________________________________________________________
  inline void
  matrix<long >::swap_row_column(iterator i, iterator j)
  {
    gsl_matrix_long_swap_rowcol(_matrix,i, j);
  }
  //__________________________________________________________________
  inline bool
  matrix<long >::is_owner()  const
  {
    return _matrix->owner == 1;
  }
  //__________________________________________________________________
  inline bool
  matrix<long >::is_null()  const 
  {
    return gsl_matrix_long_isnull(_matrix) == 1;
  }
  //__________________________________________________________________
  inline void
  matrix<long >::zero() 
  {
    gsl_matrix_long_set_zero(_matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<long >::set(value_type x) 
  {
    gsl_matrix_long_set_all(_matrix, x);
  }
  //__________________________________________________________________
  inline void
  matrix<long >::identity()
  {
    gsl_matrix_long_set_identity(_matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<long >::transpose()
  {
    gsl_matrix_long_transpose(_matrix);
  }
  //__________________________________________________________________
  inline matrix<long >
  matrix<long >::operator()(iterator i, iterator j, size_type n1, 
				   size_type n2) const
  {
    return matrix<long >(*this, i, j, n1, n2);
  }
  //__________________________________________________________________
  inline 
  const matrix<long >::reference_type
  matrix<long >::operator()(iterator i, iterator j) const 
  {
#if 0
    return reference_type(gsl_matrix_long_ptr(_matrix, i, j));
#else 
    return reference_type(*(gsl_matrix_long_ptr(_matrix, i, j)));
#endif
  }
  //__________________________________________________________________
  inline 
  matrix<long >::reference_type
  matrix<long >::operator()(iterator i, iterator j) 
  {
#if 0
    return reference_type(gsl_matrix_long_ptr(_matrix, i, j));
#else 
  ...
  //__________________________________________________________________
  inline matrix<long >::vector_type
  matrix<long >::operator[](iterator i)
  {
    // Must be implemented here - temporary
    return vector_type(gsl_matrix_long_row(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<long >::vector_type
  matrix<long >::operator[](iterator i) const
  {
    // Must be implemented here - temporary
    return vector_type(gsl_matrix_long_row(_matrix,i));
  }
  //__________________________________________________________________
  inline matrix<long >::value_type*
  matrix<long >::element(iterator row, iterator column) 
  {
    // Must be implemented here - temporary
    
    return (value_type*)(gsl_matrix_long_ptr(_matrix,row, column));
  }
  //__________________________________________________________________
  inline const matrix<long >::value_type*
  matrix<long >::element(iterator row, iterator column) const
  {
    // Must be implemented here - temporary
    return (value_type*)(gsl_matrix_long_const_ptr(_matrix,row, column));
  }
  //__________________________________________________________________
  inline matrix<long >::vector_type
  matrix<long >::row(iterator i)
  {
    return vector_type(gsl_matrix_long_row(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<long >::vector_type
  matrix<long >::row(iterator i) const
  {
    return vector_type(gsl_matrix_long_row(_matrix,i));
  }
  //__________________________________________________________________
  inline matrix<long >::vector_type
  matrix<long >::column(iterator i)
  {
    return vector_type(gsl_matrix_long_column(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<long >::vector_type
  matrix<long >::column(iterator i) const
  {
    return vector_type(gsl_matrix_long_column(_matrix,i));
  }
  //__________________________________________________________________
  inline matrix<long >::vector_type
  matrix<long >::diagonal(int i)
  {
    if (i == 0)     
      return vector_type(gsl_matrix_long_diagonal(_matrix));
    else if (i < 0) 
      return 
	vector_type(gsl_matrix_long_subdiagonal(_matrix,-i));
    return 
      vector_type(gsl_matrix_long_superdiagonal(_matrix,i));
  }
  //__________________________________________________________________
  inline const matrix<long >::vector_type
  matrix<long >::diagonal(int i) const
  {
    if (i == 0)     
      return vector_type(gsl_matrix_long_diagonal(_matrix));
    else if (i < 0) 
  ...
  //__________________________________________________________________
  inline matrix<long >::vector_type
  matrix<long >::sub_diagonal(int i)
  {
    return diagonal(-i);
  }
  //__________________________________________________________________
  inline const matrix<long >::vector_type
  matrix<long >::sub_diagonal(int i) const
  {
    return diagonal(-i);
  }
  //__________________________________________________________________
  inline matrix<long >::vector_type
  matrix<long >::super_diagonal(int i)
  {
    return diagonal(i);
  }
  //__________________________________________________________________
  inline const matrix<long >::vector_type
  matrix<long >::super_diagonal(int i) const
  {
    return diagonal(i);
  }
  //__________________________________________________________________
  ...
  matrix<long >::operator*=(const matrix<value_type>& m)
  {
    gsl_matrix_long_mul_elements(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<long >&
  matrix<long >::operator/=(const matrix<value_type>& m)
  {
    gsl_matrix_long_div_elements(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<long >&
  matrix<long >::operator+=(const matrix<value_type>& m)
  {
    gsl_matrix_long_add(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<long >&
  matrix<long >::operator-=(const matrix<value_type>& m)
  {
    gsl_matrix_long_sub(_matrix,m._matrix);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<long >&
  matrix<long >::operator+=(const value_type& x)
  {
    gsl_matrix_long_add_constant(_matrix,x);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<long >&
  ...
  matrix<long >::operator*=(const value_type& x)
  {
    gsl_matrix_long_scale(_matrix,x);
    return *this;
  }
  //__________________________________________________________________
  inline matrix<long >&
  ...
  //__________________________________________________________________
  inline 
  matrix<long >::value_type
  matrix<long >::min() const 
  {
    return gsl_matrix_long_min(_matrix);
  }
  //__________________________________________________________________
  inline 
  matrix<long >::value_type
  matrix<long >::max() const 
  {
    return gsl_matrix_long_max(_matrix);
  }
  //__________________________________________________________________
  inline void
  matrix<long >::minmax(value_type& min, value_type& max) const 
  {
    return gsl_matrix_long_minmax(_matrix, &min, &max);
  }
  //__________________________________________________________________
  inline void
  matrix<long >::min_index(iterator& row, iterator& column) const 
  {
    gsl_matrix_long_min_index(_matrix, &row, &column);
  }
  //__________________________________________________________________
  inline void
  matrix<long >::max_index(iterator& row, iterator& column) const 
  {
    gsl_matrix_long_max_index(_matrix, &row, &column);
  }
  //__________________________________________________________________
  inline void
  matrix<long >::minmax_index(iterator& min_row, iterator& min_column,
			       iterator& max_row, iterator& max_column) 
    const 
  {
    gsl_matrix_long_minmax_index(_matrix, &min_row, &min_column,
					  &max_row, &max_column);
  }
#endif
}
